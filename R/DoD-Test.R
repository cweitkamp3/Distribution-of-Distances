...
#' The DoD-Statistic
#' 
#' Calculate the (unscaled) DoD-statistic proposed in \insertCite{weitkamp2020gromov;textual}{DoD} for two samples of size n and m.
...
#' samples \code{input1} and \code{input2} (for more details see \insertCite{weitkamp2020gromov;textual}{DoD}).
#'  
#' If both inputs are quadratic numeric matrices (and \code{force.coordinates}==F), they will be interpreted as distance matrices. Otherwise, they are considered as coordinate matrices
#' and the interpoint distances are calculated with \code{dist} and the method specified.
#'
#' @return 
#' The function returns the value of the DoD-statistic (defined in \insertCite{weitkamp2020gromov;textual}{DoD}).
#' 
#' @examples
#' n= 100
#' 
...
#' hypothesis based on a sample of size n (see Section 3 of \insertCite{weitkamp2020gromov;textual}{DoD} for additional information).
...
#' \strong{H:}  \emph{"The distributions of (interpoint) distances of both inputs are equal."}
#'  
#' is required. This function implements the resampling scheme proposed in Section 3 of \insertCite{weitkamp2020gromov;textual}{DoD} to approximate this limit distribution.  
#'  
...
#' scheme proposed in Section 3 of \insertCite{weitkamp2020gromov;textual}{DoD} in order to approximate the limit distribution of the DoD-Statistic under the null hypothesis.
#' 
#' @examples
#' n= 100
#' 
